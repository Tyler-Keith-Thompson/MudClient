...
for _, n in ipairs({
  "trigger", "alias", "gag", "suppress", "replace", "substitute", "send",
  "rule_remove", "rule_enable", "class_enable", "class_remove",
  "untrigger", "unalias", "ungag", "unsuppress", "unreplace", "unsubstitute",
  ...
  "unbind", "input_set", "bell", "title", "notify", "badge", "attention", "set_uservar", "copy", "timestamps", "disconnect", "is_connected", "connect", "telnet_send", "on_stream",
