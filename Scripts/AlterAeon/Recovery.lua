...
local choose_recovery_position
local maybe_complete_recovery
local maybe_lifetap
local ensure_regen
local warm_regen_on_first_vitals
local end_recovery
...
choose_recovery_position = function()
...
end_recovery = function(completed, reason)
   state.recover = false
   reset_narration()
...
maybe_complete_recovery = function()
...
warm_regen_on_first_vitals = function()
