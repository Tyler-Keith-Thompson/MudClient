...
if rx then
   ...
   T([[^You (say|gossip|chat|auction|yell|shout|newbie|tell)\b|(?:tells you|tells the group|gossips|chats|auctions|yells|shouts|newbies|says), ']]):
   subscribe(function(c) speak_line((c).line) end)



   T([[\b(?:chuckles?|laughs?|giggles?|snickers?|cackles?|sighs?|groans?|gasps?|cry|cries|screams?|snorts?)\b]]):
   subscribe(function(c) speak_emote((c).line) end)
end
